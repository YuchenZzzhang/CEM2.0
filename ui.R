...
fluidPage(
 ...
 #   mainPanel(
      navlistPanel(#type="tabs",
                  ...
                  tabPanel("Introduction",
                           h5(strong("Welcome! This website is where you start your CEM 2.0 Country Scan!"), style="color: #009FDA"),
                           h5(" "),
                           h5("This website can be used in three ways: ", style="color: #002244"),
                           h5(strong("1. Generate the data input needed to run the CEM 2.0 Country Scan Excel tool")),
                           h5(strong("2. Evaluate critical periods for a target country (Question A of the “CEM 2.0 Country Scan Guidelines”)")),
                           h5(strong("3. Assess possible structural and aspirational peers for a country in question (Question B of the “CEM 2.0 Country Scan Guidelines”)")),
                           h5(" "),
                           h5("If you are conducting a CEM 2.0 or growth study, it is strongly encouraged that you complete steps A and B before selecting your final inputs for the data download. As a reminder, the resources presented on this website are intended to guide teams in their thinking – final inputs should reflect both quantitative and qualitative inputs.", style="color: #002244"),
                           
                           h5(" "),
                           h5("The CSV file generated by your selections on this website is compatible with the CEM 2.0 Country Scan Excel tool. The CEM 2.0 Country Scan Excel tool automatically uses your target country and period selection to generate a set of charts and data tables. The tool’s analytical outputs follow the 22 questions in the “CEM 2.0 Country Scan Guidelines”: ", style="color: #002244"),
                           
                           h5(" "),
                           img(src="CEM_questions.png", height="500"),
                           
                           h5("For further guidance, please refer to individual instructions on each webpage.", style="color: #002244"),
                           h5("For questions and troubleshooting, please contact Maria Andersen, ext. 88117, mandersen@worldbank.org", style="color: #002244"),
                           h5(" "),
                           h5("The Comparator Selection features on this website were developed by Jingyu Gao and Yan Liu. The approach consolidates aspects of other WBG comparator selection tools (Find Friends, Dynamic Benchmarking Tool, etc.) and was vetted by a working group of WBG benchmarking experts. ", style="color: #002244")
                  ...
                  tabPanel("Question A: Period of Analysis",
                           
                           h5(strong("INSTRUCTION")),
                           #   p("Structural comparators are defined as countries that are similar to the target country in terms of selected indicators."),
                           h5("On this page you may analyze if there are any structural breaks in GDP growth during a selected period of time. The resources on this page are intended for users to answer question A of the “CEM 2.0 Country Scan Guidelines”: “What is the period of analysis?”", style="color:#009FDA"),
    ...
    #         h3(textOutput("country.txt"), style="color:#009FDA"),
             ...
             h5(strong("INSTRUCTION")),
             h5("After selecting your structural indicators, pick an aspirational indicator for which your target country aspires to improve its performance. You can define the performance level as measured either by higher global ranking or actual value, relative to all other countries in the world.", style="color:#009FDA"),
 ...
 #                         radioButtons("RANKVALUE","Select Category", choices=c("By Rank"="rank","By Value"="value"), inline=T, selected="rank"),
        ...
        tabPanel("Generate CEM Data",
                 ...
                 h5(strong("INSTRUCTION")),
                 #   p("Structural comparators are defined as countries that are similar to the target country in terms of selected indicators."),
                 h5("On this page you input your final selections and download your CEM 2.0 Data Input. Select your total period of analysis, which should include a historical period and a recent period. Next, select your list of comparators. This includes six individual peer countries (we recommend 3 structural and 3 aspirational peers) and 3 comparator groups.", style="color:#009FDA"),
                 ...
                 h4(" "),
                 h4("Comparators for Benchmarking",style="color:#009FDA"),
                 fluidRow(
                 column(4,
                 selectInput("STRUT1",NULL,
                 ...
                 fluidRow(
                 column(4,
                 selectInput("TYPO1","Group Comparators",
                             choices=c(
